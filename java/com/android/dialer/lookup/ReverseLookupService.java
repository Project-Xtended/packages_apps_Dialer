...
public class ReverseLookupService implements PhoneNumberService, Handler.Callback {
    ...
    @Override
    public void getPhoneNumberInfo(String phoneNumber, PhoneNumberService.NumberLookupListener numberListener,
    ...
    private static class LookupNumberInfo implements PhoneNumberService.PhoneNumberInfo {
        ...
        return ContactLookupResult.Type.UNKNOWN_LOOKUP_RESULT_TYPE;
        }
        @Override
